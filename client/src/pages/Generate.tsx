  ...
  const fetchThumbnail = async () => {
    ...
    try {
      ...
      if (data?.thumbnail) {
        ...
        // If the image is ready, stop loading
        if (data.thumbnail.image_url) {
          setLoading(false);
        }
        setAdditionalDetails(data.thumbnail.user_prompt || "");
        setTitle(data.thumbnail.title || "");
        setColorSchemeId(data.thumbnail.color_scheme || "vibrant");
              ...
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      maxLength={100}
                      placeholder="e.g., 10 Tips to Improve Your YouTube SEO"
                ...
                {!id && (
                  <button
                    ...
                    className="text-[15px] w-full py-3.5 rounded-full font-medium bg-gradient-to-b from-pink-500 to-pink-600 hover:from-pink-700 disabled:cursor-not-allowed transition-colors"
                  >
