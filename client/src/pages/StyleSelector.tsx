...
const StyleSelector = ({
  ...
  const styleDescriptions: Record<ThumbnailStyle, string> = {
    "Bold & Graphic":
      "Vibrant colors, strong contrasts, and clear typography to grab attention.",
    Minimalist:
      "Clean design with ample white space, simple elements, and a focus on essentials.",
    Photorealistic:
      "High-quality images with natural colors and realistic details.",
    Illustrated:
      "Hand-drawn or digitally created illustrations with a playful or artistic vibe.",
    "Tech/Futuristic":
      "Modern, sleek design with a tech-inspired aesthetic and futuristic elements.",
  };
